...
# <a id='Sec 1'>Importing Libraries and Data</a>
```{r, message=FALSE}
# importing packages
...
# <a id='Sec 2'>Data Cleaning / Pre-Processing</a>
...
# <a id='Sec 3'>Exploratory Data Analysis</a>
...
# <a id='Sec 4'>Data Cleaning / Pre-Processing (cont'd.)</a>
...
# <a id='Sec 5'>Building the Model</a>
...
view_user = function(user) {
  ...
  print(movies_ratings[movies_ratings$userId == user_ids[user],])
...
# viewing profile and recommended movies of user #8
view_user(user=8)
```

# <a id='Sec 6'>Evaluating Performance</a>

```{r}
# evaluate()
```

# <a id='Sec 7'>Conclusion</a>
